...
class AttendanceCarrysoftReportWizard(models.TransientModel):
    _name = 'attendance.carrysoft.report.wizard'
    ...
    def get_report(self):
        ...
        return self.env.ref('hr_attendance_report.carrysoft_report').report_action(self, data=data)


class ReportAttendanceCarrysoft(models.AbstractModel):
    """Abstract Model for report template.

    for `_name` model, please use `report.` as prefix then add `module_name.report_name`.
    """

    _name = 'report.hr_attendance_report.carrysoft_report_view'
